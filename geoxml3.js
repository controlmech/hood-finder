  ...
  var render = function (responseXML, doc) {
    ...
    doc.styles = styles;
      ...
      for (pm = 0; pm < placemarkNodes.length; pm++) {
        ...
        for (var z = 0; z < node.getElementsByTagName('ExtendedData')[0].getElementsByTagName('SchemaData')[0].getElementsByTagName('SimpleData').length; z++) {
            if (node.getElementsByTagName('ExtendedData')[0].getElementsByTagName('SchemaData')[0].getElementsByTagName('SimpleData')[z].attributes.name.value === "NEIGHBOURHOOD") {
                placemark.name = geoXML3.nodeValue(node.getElementsByTagName('ExtendedData')[0].getElementsByTagName('SchemaData')[0].getElementsByTagName('SimpleData')[z].childNodes[0]);
            }
        }
